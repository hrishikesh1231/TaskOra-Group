...
// const PostGigForm = () => {
//   const { setCity } = useContext(CityContext); // district context
//   const { incrementGig } = useContext(CountsContext); // ⭐ added
//   const navigate = useNavigate();
...
//     try {
//       // ✅ API call (using global axios baseURL)
//       const res = await axios.post("/addGig", formData);

//       // ⭐ Update navbar gig count instantly
//       incrementGig();
...
//       // 💰 Token deduction notification (UX improvement)
...
//       setTimeout(() => {
//         setCity(formData.district); // update district context
...
//       // ❌ Error Toast
//       toast.error(
//         err.response?.data?.error || "Gig rejected by AI or invalid data",
//         { autoClose: 3000 }
//       );
//     } finally {
//       setLoading(false);
